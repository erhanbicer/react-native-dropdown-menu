...
class DropdownMenu extends Component {
    ...
    renderActivityPanel() {
        if (this.state.activityIndex >= 0) {
            ...
            return (
                <View style={[this.props.panelStyle, { position: 'absolute', left: 0, right: 0, top: 40, bottom: 0 }]}>
                    ...
                    <ScrollView style={[{ position: 'absolute', top: 0, left: 0, right: 0, backgroundColor: 'white' }, heightStyle]}>
                        {
                            currentTitles.map((title, index) =>
                                <TouchableOpacity key={index} activeOpacity={1} style={{ flex: 1, height: 44 }} onPress={this.itemOnPress.bind(this, index)}>
                                    {this.renderChcek(index, title.title)}
        ...
        return (
            <View style={{ flexDirection: 'column', flex: 1 }}>
                <View style={[this.props.style,{
                    ...
                    <TouchableOpacity
                        activeOpacity={1}
                        onPress={this.openOrClosePanel.bind(this, 0)}
                        ...
                        <View style={{ flexDirection: 'row', alignItems: "center", justifyContent: "center" }}>
                            <Text
                                style={[
                                    ...
                                    {
                                        color: (0 === this.state.activityIndex) ?
